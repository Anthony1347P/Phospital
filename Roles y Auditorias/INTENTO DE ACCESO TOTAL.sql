...
--- SECCION 1: ROLES PERSONALIZADOS Y PERMISOS (5 ROLES)



--- ROL 1: ADMINISTRADOR (Control total sobre los esquemas)
...
--- ROL 1: ALUMNO 
---(Desarrollo completo - permisos )
CREATE ROLE rol_alumno;
GRANT BACKUP DATABASE TO rol_alumno;
GRANT BACKUP LOG TO rol_alumno;
GRANT CREATE TABLE TO rol_alumno;
GRANT CREATE VIEW TO rol_alumno;
GRANT CREATE PROCEDURE TO rol_alumno;
GRANT CREATE FUNCTION TO rol_alumno;
GRANT CREATE TYPE TO rol_alumno;
GRANT CREATE SCHEMA TO rol_alumno;
GRANT VIEW DATABASE STATE TO rol_alumno;
GRANT VIEW DEFINITION TO rol_alumno;
GRANT SHOWPLAN TO rol_alumno;
GRANT ALTER ANY SCHEMA TO rol_alumno;
GRANT ALTER ANY USER TO rol_alumno;
...
GRANT CONTROL ON SCHEMA::dbo TO rol_alumno;
GO

--- ROL 2: ANALISTA (Para Power BI y Reportes)
CREATE ROLE rol_analista;
GRANT SELECT ON OBJECT::Secretaria.Vista_PowerBI TO rol_analista;
GO

--- ROL 3: INVITADO (Solo vistas)
...
--- ROL 4: PROFESOR (Acceso a evaluacion del proyecto)
...
--- USUARIO 1: ADMINISTRADOR (Control total con db_owner)
...
--- USUARIO 2: ALUMNO (Desarrollo con permisos detallados)
