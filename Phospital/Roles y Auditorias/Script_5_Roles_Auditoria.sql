...
--- Incluye: 5 Roles, 5 Usuarios, Auditoria Servidor y BD

USE PHospital
GO


--- SECCION 1: ROLES PERSONALIZADOS Y PERMISOS ( ROLES)
...
ADD (EXECUTE ON OBJECT::Tesoreria.CrearFacturaPorConsulta BY public)
WITH (STATE = ON);
GO
